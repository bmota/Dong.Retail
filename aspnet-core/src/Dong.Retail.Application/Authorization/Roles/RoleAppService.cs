...
using Dong.Retail.Authorization.Permissions;
using Dong.Retail.Authorization.Permissions.Dto;
using Dong.Retail.Authorization.Roles.Dto;

namespace Dong.Retail.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : RetailAppServiceBase, IRoleAppService
    {
