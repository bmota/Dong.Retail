...
using Dong.Retail.Authentication.TwoFactor.Google;
...
using Dong.Retail.Web.Authentication.TwoFactor;
using Dong.Retail.Web.Models.TokenAuth;
using Dong.Retail.Authorization.Impersonation;
using Dong.Retail.Identity;
using Dong.Retail.Notifications;
using Dong.Retail.Web.Authentication.External;

namespace Dong.Retail.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : RetailControllerBase
    {
