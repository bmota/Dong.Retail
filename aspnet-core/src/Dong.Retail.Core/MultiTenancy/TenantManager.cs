...
using Dong.Retail.MultiTenancy.Demo;
...
namespace Dong.Retail.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(RetailConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
