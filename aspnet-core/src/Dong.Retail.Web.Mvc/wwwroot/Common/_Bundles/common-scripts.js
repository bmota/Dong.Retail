...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['Dong.Retail.MyNotificationDataType'] = function(userNotification) {
...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('Retail');
